...
const liveLeft = document.querySelector(".live-arrow.left");
const liveRight = document.querySelector(".live-arrow.right");

liveLeft.addEventListener("click", () => {
  liveTrack.scrollBy({ left: -300, behavior: "smooth" });
});
...
// login page 
  ...
  const pageCloseBtn = document.querySelector(".close-btn");
